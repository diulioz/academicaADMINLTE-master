...
Route::get('/profesores/registrar', [Programas::class, 'form_registro']);
Route::post('/profesores/registrar', [Programas::class, 'registrar']);
Route::get('/profesores/eliminar/{id}', [Programas::class, 'eliminar'])->name('eliminaProf');
